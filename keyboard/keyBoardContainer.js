...
export default () => {
  ...
  toggleNightTheme.innerHTML = '<div class="toggle__circle"><span class="material-icons">dark_mode</span></div>';
  ...
  text.innerHTML = '<span>The keyboard was created in the Windows operating system</span><br><span>To switch the language combination: left ctrl + alt</span>';
